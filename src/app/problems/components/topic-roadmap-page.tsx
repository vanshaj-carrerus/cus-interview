              ...
              <div className="flex flex-col">
                ...
                <div className="mt-2 flex gap-1">
                  {topic.levels.map((_, i) => (
                    <div
                      key={i}
                      className={`h-1 w-4 rounded-full transition-colors duration-500 ${i < passedLevels.length
                        ? "bg-primary"
                        : "bg-slate-100"
                        }`}
                    />
          ...
          <div className="space-y-6 relative z-10">
            {topic.levels.map((level, index) => {
              ...
              return (
                ...
                >
                  {/* Card Section */}
                  <div className={`flex-1 w-full flex ${isLeft ? "justify-start" : "justify-end"}`}>
                    <div
                      className={`
                      group relative p-5 rounded-4xl border transition-all duration-300 w-full max-w-[500px]
                    ...
                    >
                      ...
                      <h3 className="text-base sm:text-lg md:text-xl font-bold text-slate-800 whitespace-nowrap">
                        {level.title}
                      </h3>
                  ...
                  <div className="relative flex items-center justify-center w-12 h-12 shrink-0">
                    ...
                    {isCurrent && (
                      <span className="absolute inset-0 rounded-full bg-indigo-400  opacity-20" />
                    )}
                  </div>
