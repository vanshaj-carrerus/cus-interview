         ...
         <div className=" max-w-7xl md:container! mx-auto px-6">
            <div className="flex flex-col lg:flex-row items-center gap-20">
               ...
               <div className="flex-1 order-2 lg:order-1 relative group w-full lg:w-auto">
                  <div className="relative z-10 bg-slate-900 rounded-[2.5rem] p-4 shadow-[0_50px_100px_rgba(0,0,0,0.3)] border border-slate-800 rotate-1 group-hover:rotate-0 transition-transform duration-700">
                     ...
                     <div className="flex items-center justify-between px-6 py-4 border-b border-white/5">
                        ...
                        <div className="px-4 py-1.5 bg-white/5 rounded-lg text-[10px] font-black text-white/40 uppercase tracking-widest">solution.cpp</div>
                        <div className="w-12" />
                     </div>
                     ...
                     <div className="p-8 font-mono text-sm leading-relaxed text-white">
                        ...
                        <div className="flex gap-4">
                           ...
                           <p className="text-accent-purple">#include <span className="text-accent-teal">&lt;iostream&gt;</span></p>
                        </div>
                        <div className="flex gap-4">
                           <span className="text-white/10 select-none">02</span>
                           <p className="text-white/40">using namespace <span className="text-white">std</span>;</p>
                        </div>
                        <div className="flex gap-4">
                        ...
                        <div className="flex gap-4">
                           ...
                           <p className="text-primary font-bold">int <span className="text-white">main</span>() {"{"}</p>
                        </div>
                        <div className="flex gap-4 pl-4">
                           <span className="text-white/10 select-none">05</span>
                           <p className="text-white/60">vector&lt;int&gt; nums = {"{2, 7, 11, 15}"};</p>
                        </div>
                        <div className="flex gap-4 pl-4">
               ...
               <div className="flex-1 order-1 lg:order-2">
                  <h2 className="text-sm font-black text-primary uppercase tracking-[0.3em] mb-6">World Class Editor</h2>
                  ...
                  <p className="text-secondary/50 text-lg font-medium leading-relaxed mb-10">
                     Practice in an environment that mimics top-tier IDEs. Designed specifically for coding interviews with 20+ language supports.
                  </p>

                  <div className="space-y-8 mb-12">
                     {[
                        { title: "Multi-Language Support", desc: "Write code in C++, Java, Python, Go, and more." },
                        { title: "Custom Test Cases", desc: "Run your code against specific inputs easily." },
                        { title: "Auto-completion", desc: "Intelligent suggestions to code faster." }
                     ].map((item, i) => (
                        <div key={i} className="flex gap-6">
                           ...
                           <div>
                              <h4 className="font-black text-secondary text-base mb-1">{item.title}</h4>
                              <p className="text-secondary/40 text-sm font-medium">{item.desc}</p>
                           </div>
                        </div>
                     ))}
                  </div>

                  <button className="px-10 py-4 bg-secondary text-white font-black text-sm uppercase tracking-widest rounded-2xl shadow-xl hover:-translate-y-1 transition-all">
                     Start Coding
                  </button>
               </div>
            </div>
