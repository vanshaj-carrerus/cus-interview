        ...
        <div className=" max-w-7xl md:container! mx-auto px-6 flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="flex-1 text-center lg:text-left z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/10 rounded-full mb-8">
              ...
              <span className="text-primary text-[10px] font-black uppercase tracking-widest">Global Staffing & Coaching</span>
            </div>
            ...
            <p className="text-secondary/60 text-lg md:text-xl font-medium leading-relaxed mb-10 max-w-xl mx-auto lg:mx-0">
              Elevating career journeys through innovative IT solutions and our comprehensive job portal. Shape the future with CareerUs Solutions.
            </p>
            ...
            <div className="mt-16 pt-10 border-t border-slate-200 flex flex-col sm:flex-row items-center gap-8 lg:items-start group">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map(i => (
                  <div key={i} className="w-12 h-12 rounded-2xl bg-slate-200 border-4 border-white shadow-lg overflow-hidden group-hover:translate-x-1 transition-transform" />
                ))}
                <div className="w-12 h-12 rounded-2xl bg-primary text-white flex items-center justify-center text-[10px] font-black border-4 border-white shadow-lg">10k+</div>
              </div>
              <div className="text-center sm:text-left">
                ...
                <p className="text-secondary/50 text-xs font-black uppercase tracking-widest leading-none">Empowering careers globally</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 relative w-full perspective-[2000px]">
            <div className="relative z-10 bg-white rounded-[3rem] p-3 shadow-[0_50px_100px_rgba(31,61,143,0.12)] border border-slate-100 rotate-y-[-10deg] rotate-x-[5deg] hover:rotate-y-0 hover:rotate-x-0 transition-transform duration-1000">
              <div className="bg-slate-50 rounded-[2.5rem] overflow-hidden aspect-[4/3] relative">
                {/* Top Header Mockup */}
                <div className="flex items-center justify-between px-8 py-6 border-b border-slate-200 bg-white">
                  ...
                  <div className="px-3 py-1 bg-primary/10 rounded-lg text-[8px] font-black uppercase text-primary tracking-widest">CUS</div>
                </div>
            ...
            <div className="absolute -top-10 -right-10 bg-white pro-card p-6 shadow-2xl animate-float hidden sm:block">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-orange-100 flex items-center justify-center text-orange-500">🏢</div>
                <div>
                  <p className="text-secondary font-black text-xs">Top Staffing</p>
                  <p className="text-secondary/40 text-[10px] font-bold">2026 Award Winner</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-10 -left-10 bg-white pro-card p-6 shadow-2xl animate-float [animation-delay:1.5s] hidden sm:block">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary font-black">AI</div>
                <div>
                  <p className="text-secondary font-black text-xs">Career Coaching</p>
                  <p className="text-secondary/40 text-[10px] font-bold">AI-Powered Paths</p>
                </div>
              </div>
            </div>
